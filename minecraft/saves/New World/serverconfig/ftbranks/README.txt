...
Last README file update: Sun May 23 11:39:21 EDT 2021
...
command.dt.settree.location.species.jo_code.turns.soillife
command.dt.soillife
command.dt.soillife.location
command.dt.soillife.location.raw
command.dt.soillife.location.soil_life
command.dt.specieslist
...
command.locate.dungeonsmod:the_camp
command.locate.dungeonsmod:the_castle
command.locate.dungeonsmod:the_catacombs
command.locate.dungeonsmod:the_chapel
command.locate.dungeonsmod:the_house
command.locate.dungeonsmod:the_lab
command.locate.dungeonsmod:the_mines
command.locate.dungeonsmod:the_origin
command.locate.dungeonsmod:the_ship
...
command.pother.influence
command.pother.influence.pollutant
command.pother.list
